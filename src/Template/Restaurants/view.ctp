    	...
    	<div class="row">
    		...
    		<aside class="col-sm-7">
                <article class="card-body p-5">
                    <input type="text" hidden data-attr="<?= h($restaurant->id)  ?>" value="<?= $restaurant->id?>" id="restaurantId" />
                    ...
                    <div class="form-group" id="rating-ability-wrapper">
                        <label class="control-label" for="rating">
                            <span class="field-label-header">How would you rate this restaurant? </span><br>
